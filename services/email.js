...
const sendEmail = (email, verificationToken, name) => {
    ...
    const emailOptions = {
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 20px; border-radius: 10px;">
        ...
        <a target="_blank" style="display: inline-block; margin: 0 auto; font-size: 18px; background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;" href="https://HannaVakulenko.github.io/teamproject-frontend-1/${verificationToken}">Activate Account</a>
        </div>
        <br>
